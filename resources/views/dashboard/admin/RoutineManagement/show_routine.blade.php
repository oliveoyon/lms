            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">{{ __('language.add_class_period') }}</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <div class="card-tools">
                                <ul class="nav nav-pills ml-auto">
                                    <li class="nav-item">
                                        ...
                                        <a href="{{ route('admin.createClassRoutine') }}" class="btn btn-success btn-m">{{ __('language.add_class_period') }}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered table-striped table-hover table-sm" id="class-routines-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning btn-xs" data-id="{{ $classRoutine->id }}" id="viewClassRoutineDetailsBtn"><i class="fas fa-edit"></i>
                                            </button>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="viewClassRoutineDetailsModalLabel">{{ __('language.period_view_details') }}</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.updateClassPeriodDetails') }}" method="post" autocomplete="off" id="update-classPeriod-form">
                    ...
                    <table class="table table-bordered" id="periodTable"> 
                        <thead>
                            <tr>
                                <th>{{ __('language.period_name') }}</th>
                                <th>{{ __('language.start_time') }}</th>
                                <th>{{ __('language.end_time') }}</th>
                                <th>{{ __('language.action') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <button type="button" class="btn btn-success" id="addRowBtn">{{ __('language.add_row') }}</button>
