            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="{{ route('admin.assignStdTrans') }}" method="POST" autocomplete="off"
                            id="add-attendance-form">
                            @csrf

                            <div class="card">
                                <div class="card-header bg-gray">
                                    <h3 class="card-title">Transport Fee Assignment</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select id="student_id" name="std_id[]" multiple
                                                    class="form-control form-control-sm student_id select2 required" disabled>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-control-sm" name="route_id" id="drop_stopage">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="pickup_stopage">{{ __('language.pickup_stopage') }}</label>
                                                <select class="form-control form-control-sm" name="pickup_stopage" id="pickup_stopage">
                                                    <!-- Populate this dropdown with data from the 'trans_stopages' table -->
                                                    @foreach($stopages as $stopage)
                                                        <option value="{{ $stopage->id }}">{{ $stopage->stopage_name }}</option>
                                                    @endforeach
                                                </select>
                                                <span class="text-danger error-text pickup_stopage_error"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control form-control-sm" name="pickup_time" id="pickup_time"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control form-control-sm" name="drop_time" id="drop_time"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="tr_assign_status">{{ __('language.status') }}</label>
                                                <select class="form-control form-control-sm" name="tr_assign_status" id="event_status">
                                                    <option value="1">{{ __('language.active') }}</option>
                                                    <option value="0">{{ __('language.inactive') }}</option>
                                                </select>
                                                <span class="text-danger error-text tr_assign_status_error"></span>
                                            </div>
                                        </div>
