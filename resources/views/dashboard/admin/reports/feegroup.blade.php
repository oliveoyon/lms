...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.FeeGroupList') }}" method="POST" autocomplete="off" id="get-version-wise-class-list">
                        @csrf
                        <div class="card">
                    ...
                    if (classes instanceof Array || classes instanceof Object) {
                        ...
                        for (var i in classes) {
                            if (classes.hasOwnProperty(i)) {
                                ...
                                var row = '<tr>' +
                                    '<td>' + serialNumber + '</td>' +
                                    '<td>' + classData.aca_group_name + '</td>' +
                                    '<td>' + classData.aca_feehead_id + '</td>' +
