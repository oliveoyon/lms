...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.dueFeeList') }}" method="POST" autocomplete="off" id="get-version-wise-class-list">
                        @csrf
                        <div class="card">
