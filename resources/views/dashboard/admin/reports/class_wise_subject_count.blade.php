...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.subject_count') }}" method="POST" autocomplete="off" id="get-version-wise-class-list">
                        @csrf
                        <div class="card">
...
<script>
    $('#printButton').click(function() {
        ...
        $.ajax({
            ...
            data: {
                pdf_data: data,
                title: 'Class Wise Total Subject',
                orientation: 'P',
            },
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
