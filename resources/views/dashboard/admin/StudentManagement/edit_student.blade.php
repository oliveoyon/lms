...
@section('title', 'Student Update Form')
@push('admincss')
    <!-- DataTables -->
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a
                                    href="{{ route('admin.home') }}">{{ __('language.manage_student') }}</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="{{ route('admin.stdEdit') }}" method="POST" autocomplete="off"
                            id="add-student-form">
                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-control-sm academic_year"
                                                    ...
                                                    @for ($i = $currentYear - 5; $i <= $currentYear + 5; $i++)
                                                        <option value="{{ $i }}"
                                                            {{ old('academic_year', $academicStudent->academic_year) == $i ? 'selected' : '' }}>
                                                            {{ $i }} - {{ $i + 1 }}
                                                        </option>
                                                    @endfor
                                                </select>
                                                ...
                                                <select class="form-control form-control-sm version_id" name="version_id"
                                                    ...
                                                    @foreach ($versions as $version)
                                                        <option value="{{ $version->id }}"
                                                            {{ old('version_id', $academicStudent->version_id) == $version->id ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="rollNo" name="roll_no"
                                                        ...
                                                        value="{{ old('roll_no', $academicStudent->roll_no) }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="studentCategory" name="std_category"
                                                    class="form-control form-control-sm">
                                                    <option value="">{{ __('language.select') }}</option>
                                                    <option value="Regular"
                                                        {{ old('std_category', $student->std_category) == 'Regular' ? 'selected' : '' }}>
                                                        Regular</option>
                                                    <option value="Transferred"
                                                        {{ old('std_category', $student->std_category) == 'Transferred' ? 'selected' : '' }}>
                                                        Transferred</option>
                                                    <option value="Interchanged"
                                                        {{ old('std_category', $student->std_category) == 'Interchanged' ? 'selected' : '' }}>
                                                        Interchanged</option>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="studentPhoneAlt">S{{ __('language.students_phone_alternative') }}:</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                                        <i class="fas fa-phone"></i>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(data.classes, function(key, value) {
                ...
                if (value.id == {{ $academicStudent->class_id }}) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(data.sections, function(key, value) {
                ...
                if (value.id == {{ $academicStudent->section_id }}) {
                    option.prop('selected', true);
                }
