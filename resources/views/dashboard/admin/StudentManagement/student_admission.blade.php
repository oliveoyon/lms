                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="feeSetup" name="feeSetup" class="form-control form-control-sm">
    ...
    $('#add-student-form').on('submit', function (e) {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                ...
                // Remove 'is-invalid' class before making the new request
            ...
            success: function (data) {
                if (data.code == 0) {
                    ...
                    // Reset form and remove 'is-invalid' classes on success
